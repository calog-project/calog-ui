...
const schedules = [
  { start: '2024-12-20', end: '2024-12-23', title: '캘로그', color: '#000000' },
  { start: '2024-12-25', end: '2024-12-25', title: '크리스마스', color: '#3366fe' },
  { start: '2024-12-25', end: '2024-12-25', title: '크리스마스', color: '#3366fe' },
  { start: '2024-12-25', end: '2024-12-25', title: '크리스마스', color: '#3366fe' },
  { start: '2024-12-25', end: '2024-12-25', title: '크리스마스', color: '#3366fe' },
  { start: '2024-12-25', end: '2024-12-25', title: '크리스마스', color: '#3366fe' },
  { start: '2025-1-1', end: '2025-1-1', title: '새해', color: '#3366fe' },
];
